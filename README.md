...
When a commit to the `main` branch occurs (for example, when a pull request is merged), CI builds the manuscript and writes the results to the [`gh-pages`](https://github.com/hwong23/fna-devdoc-f1-1/tree/gh-pages) and [`output`](https://github.com/hwong23/fna-devdoc-f1-1/tree/output) branches.
